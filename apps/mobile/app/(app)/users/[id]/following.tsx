  ...
  return (
    <SafeAreaView style={styles.root} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>{t ? 'Siguiendo' : 'Following'}</Text>
        <View style={{ width: 40 }} />
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              message={t ? 'Explora usuarios para verlos aquí cuando los sigas.' : 'Explore users to see them here once you follow.'}
            />
          }
        />
      )}
